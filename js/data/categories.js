...
export const CATEGORIES = [
  ...
  {id:'antiaging',name:'Anti-Aging',icon:'✨',color:'#ffb347',peptides:['GHK-Cu','GHK-Cu (Topical)','Epithalon','Epithalon (Nasal)','Epitalon + Thymalin Combo','Snap-8','L-Glutathione','Glutathione IV','Vitamin C IV','Melatonin','Carnosine','Spermidine','Rapamycin','Rapamycin (Low Dose)','Palmitoyl Pentapeptide-4','Acetyl Hexapeptide-3','Spilanthol','Klotho','Resveratrol','Fisetin','Quercetin']},
