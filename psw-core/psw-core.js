...
(function () {
  ...
  // ── Compound Reference Guide ──────────────────────────────────
  var REF_BASE = C.refBase || 'https://jmitsuominor-ux.github.io/peptide-reference/';
  ...
  function buildRefGuide(base) {
    return (
      '<div class="pref-wrap">' +
        '<div class="pref-inner">' +
          '<div class="pref-label">Compound Reference Guide</div>' +
          '<div class="pref-scroll">' +
            REF_CATS.map(function(c) {
              return (
                '<a class="pref-card" href="' + base + '?cat=' + c.id + '" target="_blank" rel="noopener">' +
...
.pref-wrap{padding:14px 20px 16px;background:rgba(7,20,40,0.7);border-top:1px solid rgba(0,180,216,0.15);border-bottom:1px solid rgba(0,180,216,0.15);backdrop-filter:blur(8px);position:relative;z-index:1;}
.pref-inner{max-width:1200px;margin:0 auto;}
.pref-label{font-family:var(--mono);font-size:10px;font-weight:700;color:var(--cyan);letter-spacing:0.15em;text-transform:uppercase;margin-bottom:10px;display:flex;align-items:center;gap:8px;}
